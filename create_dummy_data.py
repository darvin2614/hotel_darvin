...
print("Creating dummy data for admin panel...")
...
print(f'✓ Created {len(created_hotels)} dummy hotels')
...
print(f'✓ Created {len(created_rooms)} dummy rooms')
...
print(f'✓ Created {len(created_bookings)} dummy bookings')
